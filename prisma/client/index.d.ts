...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateDocument = {
    count: DocumentCountAggregateOutputType | null
  ...
  export type DocumentAggregateArgs = {
    ...
    **/
    orderBy?: Enumerable<documentOrderByInput>
    /**
    ...
    **/
    count?: true | DocumentCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
  ...
  export type GetDocumentAggregateType<T extends DocumentAggregateArgs> = {
    [P in keyof T & keyof AggregateDocument]: P extends 'count'
      ? T[P] extends true
        ? number
  ...
  export type DocumentGroupByArgs = {
    ...
    take?: number
    skip?: number
    count?: DocumentCountAggregateInputType | true
    min?: DocumentMinAggregateInputType
    max?: DocumentMaxAggregateInputType
  }
  ...
  type GetDocumentGroupByPayload<T extends DocumentGroupByArgs> = Promise<Array<
    PickArray<DocumentGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof DocumentGroupByOutputType))]: GetScalarType<T[P], DocumentGroupByOutputType[P]>
    }
  >>
  ...
  export type documentScalarWhereWithAggregatesInput = {
    ...
    documentData?: JsonWithAggregatesFilter
  }

  export type documentCreateInput = {
    id?: string
    documentId?: string | null
    documentData: InputJsonValue
  }
